...
from m2_mixer.usecases.imagenet.models import NUM_CLASSES, ImagenetMixer
...
def model(request, optimizer_cfg):
    ...
    return ImagenetMixer(model_cfg=config, optimizer_cfg=optimizer_cfg)
...
@pytest.fixture
def batch():
    return torch.randn(10, 3, 224, 224), torch.randint(0, NUM_CLASSES, (10,))
